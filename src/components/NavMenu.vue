<template>
  <div class="navMenu">
    <div :class="{ navMenuItem: true, active: checkNavSelectedRss }" @click="handleNav('/rss')" title="Rss订阅">
    ...
    <div :class="{ navMenuItem: true, active: checkNavSelected6pan }" @click="handleNav('/6pan')" title="6盘">
    ...
    <div :class="{ navMenuItem: true, active: checkNavSelectedDown }" @click="handleNav('/down')" title="下载">
