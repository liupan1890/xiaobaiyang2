<template>
  <a-modal key="VerUpdateModal" :visible="checkShowModal" title="" :footer="null" @cancel="handleCancel" class="appmodal">
...
export default {
  ...
  computed: {
    checkShowModal: function() {
      return this.$store.state.UI.modalname == "verupdate";
    },
    serverVer: function() {
      return this.$store.state.UI.serverVer;
    },
    exeVer: function() {
      return this.$store.state.UI.exeVer;
    },
    serverVerUrl: function() {
      return this.$store.state.UI.serverVerUrl;
    },
  },
